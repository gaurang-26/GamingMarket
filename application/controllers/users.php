...
class Users extends CI_Controller{
    //register function to register a new uer using validation class!!

    public function register(){
		//Validation Rules
		$this->form_validation->set_rules('first_name','First Name','trim|required|min_length[2]|max_length[16]');
    ...
    // login function to login to the database using a particular user credinationals.
