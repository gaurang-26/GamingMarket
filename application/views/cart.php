...
<?php if($this->cart->contents()) : ?>
	...
	<p><a href="<?php echo base_url();?>users/register" class="btn btn-primary">Create A Account</a></p>
	<p><em><strong> You must log in to make purchases</strong> </em></p>
	<?php else : ?>
			<h3>Shipping Info</h3>
...
<?php else : ?>
	<p style="text-align:center;">There are no items in your cart</p>
<?php endif; ?>
