...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <form method="post" action="<?php echo base_url();?>users/login" class="form-inline my-2 my-lg-0">
      ...
      <button name="submit"  class="btn btn-secondary my-2 my-sm-0" type="submit"  style="color: chartreuse;">Login</button>
    </form>
    <?php else :?> 
    <form method="post" action="<?php echo base_url();?>users/logout" class="form-inline my-2 my-lg-0">
    <button name="submit"  class="btn btn-secondary my-2 my-sm-0" type="submit">Logout</button>
    </form>
    <?php endif ;?>
  </div>
</nav>
    ...
    <div class="container">
        ...
        <div class="col-md-8">
                ...
                <div class="card text-dark" >
                    <div class="card-header" style="text-align:center !important; background:#2ec64f;color:white;"><h4>The Gaming Place</h4>
                </div>
